        ...
        if (
          ...
          if (bricksVisible === 0) {
            ...
            if (level === 3) {
              ...
              message2.innerHTML = `Je hebt het spel uitgespeeld!<br><br>De coordinaten zijn:<br>N 52°06.828, E 004°53.253<br><br>Ga niet uit dit scherm<br>behalve als je de coordinaten<br>heb genoteerd!`;
